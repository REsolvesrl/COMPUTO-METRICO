...
def test_la_demolizione_pavimenti_e_accesa_di_default():
...
def test_la_1_01_prende_il_pavimento_interno():
    """Non «pavimento_esterno»: balconi e terrazzi sono un'altra
    lavorazione (2.24) e non devono entrare in una demolizione di
    pavimenti interni."""
