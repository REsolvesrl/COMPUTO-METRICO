...
# ⚠️ I CODICI DI IERI. La numerazione è cambiata: la serie di una voce ora è
# il numero della sua categoria (Demolizioni è la 2ª, quindi 2.1, 2.2, …),
# mentre prima partiva da zero e non tornava col numero stampato sulla
# pastiglia — «01 · Pratiche e oneri» con dentro voci 0.xx.
# Un codice non è un'etichetta: è la chiave con cui il disegno ritrova la
# voce da aggiornare, con cui il progetto salvato ritrova quantità e prezzi,
# e con cui il listino personale ritrova i tuoi prezzi. Cambiarla senza una
# tavola di conversione vorrebbe dire buttare via il lavoro di ieri.
CODICI_STORICI = {
    "0.01": "1.1",
    "0.02": "1.2",
    "0.03": "1.3",
...
def codice_aggiornato(codice):
    """Il codice di oggi per un codice di ieri (o lo stesso, se è già di
    oggi o se è una voce scritta a mano)."""
    return CODICI_STORICI.get(codice, codice)
