...
VOCI = [
    ...
    {"codice": "1.10", "categoria": "Demolizioni", "um": "ml", "prezzo": 2.0,
    ...
    {"codice": "2.09", "categoria": "Ricostruzioni e ripristini", "um": "ml",
     "prezzo": 70.0,
    ...
    {"codice": "2.12", "categoria": "Ricostruzioni e ripristini", "um": "m²",
     ...
     "nota": "Dove è stato tolto il parquet e sui raccordi tra massetti "
             "vecchi e nuovi."},
    {"codice": "2.13", "categoria": "Ricostruzioni e ripristini", "um": "ml",
     "prezzo": 16.0,
     "descrizione": "Profilo terminale in alluminio",
     "nota": "Chiude il bordo superiore del rivestimento (estetica)."},
    {"codice": "2.14", "categoria": "Ricostruzioni e ripristini", "um": "ml",
     "prezzo": 8.0,
