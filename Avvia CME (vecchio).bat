@echo off
rem ===================================================================
rem  CME - la versione VECCHIA, quella a Streamlit
rem
rem  ATTENZIONE: il programma e' "Avvia CME.bat", la versione nuova. Questa
rem  e' la RETE DI SICUREZZA: legge e scrive lo stesso archivio, e resta qui
rem  finche' la nuova non avra' lavorato qualche settimana senza sorprese.
rem  Si affaccia su tutte le schede di rete (Streamlit fa cosi'): tienila
rem  spenta quando non serve.
rem
...
title CME VECCHIO - motore in funzione (non chiudere questa finestra)
cd /d "%~dp0"
